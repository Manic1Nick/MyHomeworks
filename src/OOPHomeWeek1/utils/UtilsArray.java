...
public class UtilsArray {
    ...
    public static void findMinAndMax(int[] mas) {
        ...
        int minIndex = UtilsArray.findMinIndex(mas);
        int maxIndex = UtilsArray.findMaxIndex(mas);

        String str = UtilsArray.convertMas(mas);
    ...
    public static void averageOfHalfMas(int[] mas) {
        ...
        if (sum1 / halfMas > sum2 / halfMas) {
            UtilsArray.printPartOfMas(mas, 0, halfMas);
        } else {
            UtilsArray.printPartOfMas(mas, halfMas, mas.length);
        }
    }
    ...
    public static boolean evenElementsInMas(int size1, int size2) {
        ...
        System.out.print("\nArray1 is: ");
        UtilsArray.printMas(mas1);
        System.out.print("\nArray2 is: ");
        UtilsArray.printMas(mas2);
